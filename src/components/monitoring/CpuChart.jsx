...
export default function CpuChart() {
  ...
  return (
    <div className="bg-pm3-surface rounded-lg border border-pm3-border p-4">
      <h3 className="text-pm3-text font-semibold mb-4">CPU Usage Over Time</h3>
      <ResponsiveContainer width="100%" height={250}>
        <LineChart data={chartData}>
          <XAxis dataKey="time" tick={TICK_STYLE} axisLine={false} tickLine={false} />
          <YAxis domain={[0, 100]} tick={TICK_STYLE} axisLine={false} tickLine={false} unit="%" />
